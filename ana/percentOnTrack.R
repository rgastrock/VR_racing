...
getAllTrackGroupAccuracyCI <- function(session = 1, type = 'b'){
  ...
  data <- getAllTrackGroupAccuracy(session = session)
  trialno <- data$trial
  data1 <- as.matrix(data[,2:(dim(data)[2])])
  ...
  write.csv(confidence, file=sprintf('data/PercentOnTrackCI_AllTrack_S%03d.csv', session), row.names = F) 
  
}

plotAllTrackAccuracy <- function(session = 1, target='inline') {
  
  
  #but we can save plot as svg file
  if (target=='svg') {
    svglite(file='doc/fig/Fig6_PercentOnTrack_AllTrack.svg', width=12, height=7, pointsize=14, system_fonts=list(sans="Arial"))
  }
...
getS2AllTrackGroupAccuracyCI <- function(session = 2, type = 'b'){
  ...
  data <- getS2AllTrackGroupAccuracy(session = session)
  trialno <- data$trial
  data1 <- as.matrix(data[,2:(dim(data)[2])])
...
plotS2AllTrackAccuracy <- function(session = 2, blocks = c(1,2,3,4), target='inline') {
  
  
  #but we can save plot as svg file
  if (target=='svg') {
    svglite(file='doc/fig/Fig6A_PercentOnTrack_AllTrack_Session2.svg', width=12, height=7, pointsize=14, system_fonts=list(sans="Arial"))
  }
...
plotAllTrackAcrossSessionAccuracy <- function(target='inline'){
  
  #but we can save plot as svg file
  if (target=='svg') {
    svglite(file='doc/fig/Fig6B_PercentOnTrack_AllTrack_AllSessions.svg', width=16, height=6, pointsize=16, system_fonts=list(sans="Arial"))
  }
  ...
  # # # # # # # # # #
  # panel A: Session 1
  plotAllTrackAccuracy()
  mtext('a', side=3, outer=FALSE, line=-1, adj=0, padj=1, font=2)
  
  # # # # # # # # # #
  # panel B: Session 2
  plotS2AllTrackAccuracy()
  mtext('b', side=3, outer=FALSE, line=-1, adj=0, padj=1, font=2)
...
plotS1FirstLastAccuracy <- function(session = 1, target='inline') {
  
  
  #but we can save plot as svg file
  if (target=='svg') {
    svglite(file='doc/fig/Fig7_PercentOnTrack_AllTrack.svg', width=12, height=7, pointsize=14, system_fonts=list(sans="Arial"))
  }
...
plotS2FirstLastAccuracy <- function(session = 2, blocks = c(1,2,3,4), target='inline') {
  
  
  #but we can save plot as svg file
  if (target=='svg') {
    svglite(file='doc/fig/Fig7A_PercentOnTrack_AllTrack_Session2.svg', width=12, height=7, pointsize=14, system_fonts=list(sans="Arial"))
  }
...
plotFirstLastAllTrackAcrossSessionAccuracy <- function(target='inline'){
...
plotS1IndFirstLastAccuracy <- function(session = 1, target='inline') {
  
  
  #but we can save plot as svg file
  if (target=='svg') {
    svglite(file='doc/fig/Fig6C_IndividualPercentOnTrack_AllTrack.svg', width=12, height=7, pointsize=14, system_fonts=list(sans="Arial"))
  }
  ...
  alldat <- read.csv(file=sprintf('data/PercentOnTrack_AllTrack_S%03d.csv', session))
...
plotS2IndFirstLastAccuracy <- function(session = 2, blocks = c(1,2,3,4), target='inline') {
  
  
  #but we can save plot as svg file
  if (target=='svg') {
    svglite(file='doc/fig/Fig6D_IndividualPercentOnTrack_AllTrack_Session2.svg', width=12, height=7, pointsize=14, system_fonts=list(sans="Arial"))
  }
...
plotIndFirstLastAllTrackAcrossSessionAccuracy <- function(target='inline'){
  
  #but we can save plot as svg file
  if (target=='svg') {
    svglite(file='doc/fig/Fig6E_IndividualPercentOnTrack_AllTrack_AllSessions.svg', width=12, height=6, pointsize=16, system_fonts=list(sans="Arial"))
  }
...
retentionAccuracyANOVA <- function() {
  ...
  cat('Accuracy during first and last set in session 1 and first set in session 2:\n')
...
genTopUpAccuracyANOVA <- function() {
...
#follow up on significant interaction
genTopUpAccuracyComparisonMeans <- function(){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedAccuracy(session = 2, blockdefs=blockdefs)
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_3' | LC_part2$set == 'S2_4'),]
...
genTopUpAccuracyComparisons <- function(method='bonferroni'){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedAccuracy(session = 2, blockdefs=blockdefs)
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_3' | LC_part2$set == 'S2_4'),]
...
#effect size
genTopUpAccuracyComparisonsEffSize <- function(method = 'bonferroni'){
...
genTopUpAccuracyBayesANOVA <- function() {
...
genTopUpAccuracyComparisonsBayesfollowup <- function() {
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedAccuracy(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_3' | LC_part2$set == 'S2_4'),]
...
genAccuracyANOVA <- function() {
  ...
  firstAOV <- ezANOVA(data=LC4aov, wid=participant, dv=dv, within= c(set), type=3, return_aov = TRUE) #df is k-1 or 3 levels minus 1; N-1*k-1 for denom, total will be (N-1)(k1 -1)(k2 - 1)
  cat('Accuracy during first and last set in session 1 and first set of rotated track in session 2:\n')
  print(firstAOV[1:3]) #so that it doesn't print the aov object as well
...
revTopUpAccuracyANOVA <- function() {
...
#follow up on significant interaction
revTopUpAccuracyComparisonMeans <- function(){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedAccuracy(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_5' | LC_part2$set == 'S2_6'),]
...
revTopUpAccuracyComparisons <- function(method='bonferroni'){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedAccuracy(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_5' | LC_part2$set == 'S2_6'),]
...
#effect size
revTopUpAccuracyComparisonsEffSize <- function(method = 'bonferroni'){
...
revTopUpAccuracyBayesANOVA <- function() {
...
revTopUpAccuracyComparisonsBayesfollowup <- function() {
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedAccuracy(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_5' | LC_part2$set == 'S2_6'),]
...
revAccuracyANOVA <- function() {
  ...
  firstAOV <- ezANOVA(data=LC4aov, wid=participant, dv=dv, within= c(set), type=3, return_aov = TRUE) #df is k-1 or 3 levels minus 1; N-1*k-1 for denom, total will be (N-1)(k1 -1)(k2 - 1)
  cat('Accuracy during first and last set in session 1 and first set of reverse track in session 2:\n')
  print(firstAOV[1:3]) #so that it doesn't print the aov object as well

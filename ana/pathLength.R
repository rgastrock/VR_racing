...
getAllTrackGroupPL <- function(groups = c('T-RACING_0', 'T-RACING_180', 'T-RACING_90', 'T-RACING_270'), session = 1, target=0){
  ...
  if(target == 1){
    write.csv(ndat, file=sprintf('data/PathLength_AllTrack_S%03d.csv', session), row.names = F) 
  } else {
    return(ndat)
  }
}
...
getS2AllTrackGroupPL <- function(groups = c('T-RACING_0', 'T-RACING_180', 'T-RACING_90', 'T-RACING_270'), session = 2, target=0){
...
plotS1IndFirstLastPL <- function(session = 1, target='inline') {
  
  
  #but we can save plot as svg file
  if (target=='svg') {
    svglite(file='doc/fig/Fig9C_IndividualPathLength_AllTrack.svg', width=12, height=7, pointsize=14, system_fonts=list(sans="Arial"))
  }
  ...
  alldat <- read.csv(file=sprintf('data/PathLength_AllTrack_S%03d.csv', session))
...
plotS1IndInOutFirstLastPL <- function(session = 1, target='inline', trackloc = 'out') {
  
  
  #but we can save plot as svg file
  if (target=='svg') {
    svglite(file=sprintf('doc/fig/Fig15B_IndividualPathLength_%s_AllTrack_FirstLast.svg', trackloc), width=12, height=7, pointsize=14, system_fonts=list(sans="Arial"))
  }
  ...
  #read in individual data
  alldat <- read.csv(file=sprintf('data/PathLength_%s_AllTrack_S%03d.csv', trackloc, session))
  alldat <- alldat[,2:ncol(alldat)]
  for (pp in 1:ncol(alldat)){
    subdat <- alldat[,pp]
    b1subdat <- subdat[2:30]
...
plotS2IndFirstLastPL <- function(session = 2, blocks = c(1,2,3,4), target='inline') {
  
  
  #but we can save plot as svg file
  if (target=='svg') {
    svglite(file='doc/fig/Fig9D_IndividualPathLength_AllTrack_Session2.svg', width=12, height=7, pointsize=14, system_fonts=list(sans="Arial"))
  }
...
plotS2IndInOutFirstLastPL <- function(session = 2, blocks = c(1,2,3,4), target='inline', trackloc = 'out') {
  
  
  #but we can save plot as svg file
  if (target=='svg') {
    svglite(file=sprintf('doc/fig/Fig15C_IndividualPathLength_%s_AllTrack_FirstLast_Session2.svg', trackloc), width=12, height=7, pointsize=14, system_fonts=list(sans="Arial"))
  }
...
plotIndFirstLastAllTrackAcrossSessionPL <- function(target='inline'){
  
  #but we can save plot as svg file
  if (target=='svg') {
    svglite(file='doc/fig/Fig9E_IndividualPathLength_AllTrack_AllSessions.svg', width=12, height=6, pointsize=16, system_fonts=list(sans="Arial"))
  }
...
plotIndInOutFirstLastAllTrackAcrossSessionPL <- function(target='inline', trackloc= 'out'){
  
  #but we can save plot as svg file
  if (target=='svg') {
    svglite(file=sprintf('doc/fig/Fig16B_PathLength_%s_AllTrack_AllSessions.svg', trackloc), width=16, height=6, pointsize=16, system_fonts=list(sans="Arial"))
  }
...
getBlockedPL<- function(session, blockdefs) {
  
  dat <- read.csv(file=sprintf('data/PathLength_AllTrack_S%03d.csv', session))
...
retentionPLANOVA <- function() {
  ...
  LC_part2 <- getBlockedPL(session = 2, blockdefs=blockdefs) 
  ...
  cat('Path Length during first and last set in session 1 and first set in session 2:\n')
...
retentionPLComparisonMeans <- function(){
  ...
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPL(session = 2, blockdefs=blockdefs) 
  LC_part2 <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2'),] #keep last block here just for mean comparisons
...
#follow up on significant interaction
genTopUpPLComparisonMeans <- function(){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPL(session = 2, blockdefs=blockdefs)
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_3' | LC_part2$set == 'S2_4'),]
...
genTopUpPLComparisons <- function(method='bonferroni'){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPL(session = 2, blockdefs=blockdefs)
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_3' | LC_part2$set == 'S2_4'),]
...
#effect size
genTopUpPLComparisonsEffSize <- function(method = 'bonferroni'){
  comparisons <- genPLComparisons(method=method)
  #we can use eta-squared as effect size
  #% of variance in DV(percentcomp) accounted for
  #by the difference between target1 and target2
  comparisonsdf <- as.data.frame(comparisons)
...
genTopUpPLComparisonsBayesfollowup <- function() {
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPL(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_3' | LC_part2$set == 'S2_4'),]
...
genPLComparisons <- function(method='bonferroni'){
  #session1
  blockdefs <- list('S1_first'=c(2,5), 'S1_last'=c(295,6))
  LC_part1 <- getBlockedPL(session = 1, blockdefs=blockdefs) 
  #session2
...
#effect size
genPLComparisonsEffSize <- function(method = 'bonferroni'){
  comparisons <- genPLComparisons(method=method)
  #we can use eta-squared as effect size
  #% of variance in DV(percentcomp) accounted for 
  #by the difference between target1 and target2
...
genPLComparisonsBayesfollowup <- function() {
  #session1
  blockdefs <- list('S1_first'=c(2,5), 'S1_last'=c(295,6))
  LC_part1 <- getBlockedPL(session = 1, blockdefs=blockdefs) 
  #session2
...
#follow up on significant interaction
revTopUpPLComparisonMeans <- function(){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPL(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_5' | LC_part2$set == 'S2_6'),]
...
revTopUpPLComparisons <- function(method='bonferroni'){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPL(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_5' | LC_part2$set == 'S2_6'),]
...
#effect size
revTopUpPLComparisonsEffSize <- function(method = 'bonferroni'){
  comparisons <- revPLComparisons(method=method)
  #we can use eta-squared as effect size
  #% of variance in DV(percentcomp) accounted for 
  #by the difference between target1 and target2
  comparisonsdf <- as.data.frame(comparisons)
...
revTopUpPLComparisonsBayesfollowup <- function() {
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPL(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_5' | LC_part2$set == 'S2_6'),]
...
revPLComparisons <- function(method='bonferroni'){
  #session1
  blockdefs <- list('S1_first'=c(2,5), 'S1_last'=c(295,6))
  LC_part1 <- getBlockedPL(session = 1, blockdefs=blockdefs) 
  #session2
...
#effect size
revPLComparisonsEffSize <- function(method = 'bonferroni'){
  comparisons <- revPLComparisons(method=method)
  #we can use eta-squared as effect size
  #% of variance in DV(percentcomp) accounted for 
  #by the difference between target1 and target2
...
revPLComparisonsBayesfollowup <- function() {
  #session1
  blockdefs <- list('S1_first'=c(2,5), 'S1_last'=c(295,6))
  LC_part1 <- getBlockedPL(session = 1, blockdefs=blockdefs) 
  #session2
...
#follow up
trainPLComparisonMeans <- function(){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPL(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_7' | LC_part2$set == 'S2_8'),]
...
trainPLComparisons <- function(method='bonferroni'){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPL(session = 2, blockdefs=blockdefs)
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_7' | LC_part2$set == 'S2_8'),]
...
#effect size
trainPLComparisonsEffSize <- function(method = 'bonferroni'){
  comparisons <- trainPLComparisons(method=method)
  #we can use eta-squared as effect size
  #% of variance in DV(percentcomp) accounted for
  #by the difference between target1 and target2
  comparisonsdf <- as.data.frame(comparisons)
...
trainPLComparisonsBayesfollowup <- function() {
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPL(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_7' | LC_part2$set == 'S2_8'),]
...
getBlockedPLIN<- function(session, blockdefs) {
  
  dat <- read.csv(file=sprintf('data/PathLength_in_AllTrack_S%03d.csv', session))
  dat <- dat[,-1] #remove trial rows
  participants <- colnames(dat)
  N <- length(participants)
...
retentionPLINANOVA <- function() {
  ...
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPLIN(session = 2, blockdefs=blockdefs) 
  LC_part2 <- LC_part2[which(LC_part2$set == 'S2_1'),]
  ...
  firstAOV <- ezANOVA(data=LC4aov, wid=participant, dv=dv, within= c(set), type=3, return_aov = TRUE) #df is k-1 or 3 levels minus 1; N-1*k-1 for denom, total will be (N-1)(k1 -1)(k2 - 1)
  cat('Path Length in during first and last set in session 1 and first set in session 2:\n')
  print(firstAOV[1:3]) #so that it doesn't print the aov object as well
...
#means below
retentionPLINComparisonMeans <- function(){
  #session1
  blockdefs <- list('S1_first'=c(2,5), 'S1_last'=c(295,6))
  LC_part1 <- getBlockedPLIN(session = 1, blockdefs=blockdefs) 
  #session2
...
# retentionPLINComparisons <- function(method='bonferroni'){
#   #session1
#   blockdefs <- list('S1_first'=c(2,5), 'S1_last'=c(295,6))
#   LC_part1 <- getBlockedPLIN(session = 1, blockdefs=blockdefs) 
#   #session2
...
# 
# #effect size
# retentionPLINComparisonsEffSize <- function(method = 'bonferroni'){
#   comparisons <- retentionPLINComparisons(method=method)
#   #we can use eta-squared as effect size
#   #% of variance in DV(percentcomp) accounted for 
#   #by the difference between target1 and target2
#   comparisonsdf <- as.data.frame(comparisons)
...
retentionPLINBayesANOVA <- function() {
...
retentionPLINComparisonsBayesfollowup <- function() {
  #session1
  blockdefs <- list('S1_first'=c(2,5), 'S1_last'=c(295,6))
  LC_part1 <- getBlockedPLIN(session = 1, blockdefs=blockdefs) 
  #session2
...
#follow up on significant interaction
genTopUpPLINComparisonMeans <- function(){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPLIN(session = 2, blockdefs=blockdefs)
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_3' | LC_part2$set == 'S2_4'),]
...
genTopUpPLINComparisons <- function(method='bonferroni'){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPLIN(session = 2, blockdefs=blockdefs)
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_3' | LC_part2$set == 'S2_4'),]
...
#effect size
genTopUpPLINComparisonsEffSize <- function(method = 'bonferroni'){
  comparisons <- genPLINComparisons(method=method)
  #we can use eta-squared as effect size
  #% of variance in DV(percentcomp) accounted for
  #by the difference between target1 and target2
  comparisonsdf <- as.data.frame(comparisons)
...
# Top Up Statistics (Generalization; Bayesian) ----
genTopUpPLINBayesANOVA <- function() {
...
genTopUpPLINComparisonsBayesfollowup <- function() {
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPLIN(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_3' | LC_part2$set == 'S2_4'),]
...
#follow up on significant interaction
genPLINComparisonMeans <- function(){
  #session1
  blockdefs <- list('S1_first'=c(2,5), 'S1_last'=c(295,6))
  LC_part1 <- getBlockedPLIN(session = 1, blockdefs=blockdefs) 
  #session2
...
genPLINComparisons <- function(method='bonferroni'){
  #session1
  blockdefs <- list('S1_first'=c(2,5), 'S1_last'=c(295,6))
  LC_part1 <- getBlockedPLIN(session = 1, blockdefs=blockdefs) 
  #session2
...
#effect size
genPLINComparisonsEffSize <- function(method = 'bonferroni'){
  comparisons <- genPLINComparisons(method=method)
  #we can use eta-squared as effect size
  #% of variance in DV(percentcomp) accounted for 
  #by the difference between target1 and target2
...
genPLINComparisonsBayesfollowup <- function() {
  #session1
  blockdefs <- list('S1_first'=c(2,5), 'S1_last'=c(295,6))
  LC_part1 <- getBlockedPLIN(session = 1, blockdefs=blockdefs) 
  #session2
...
#follow up on significant interaction
revTopUpPLINComparisonMeans <- function(){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPLIN(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_5' | LC_part2$set == 'S2_6'),]
...
revTopUpPLINComparisons <- function(method='bonferroni'){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPLIN(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_5' | LC_part2$set == 'S2_6'),]
...
#effect size
revTopUpPLINComparisonsEffSize <- function(method = 'bonferroni'){
  comparisons <- revPLINComparisons(method=method)
  #we can use eta-squared as effect size
  #% of variance in DV(percentcomp) accounted for 
  #by the difference between target1 and target2
  comparisonsdf <- as.data.frame(comparisons)
...
#Top Up Statistics (Reverse direction; Bayesian) ----
revTopUpPLINBayesANOVA <- function() {
...
revTopUpPLINComparisonsBayesfollowup <- function() {
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPLIN(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_5' | LC_part2$set == 'S2_6'),]
...
#follow up on significant interaction
revPLINComparisonMeans <- function(){
  #session1
  blockdefs <- list('S1_first'=c(2,5), 'S1_last'=c(295,6))
  LC_part1 <- getBlockedPLIN(session = 1, blockdefs=blockdefs) 
  #session2
...
revPLINComparisons <- function(method='bonferroni'){
  #session1
  blockdefs <- list('S1_first'=c(2,5), 'S1_last'=c(295,6))
  LC_part1 <- getBlockedPLIN(session = 1, blockdefs=blockdefs) 
  #session2
...
#effect size
revPLINComparisonsEffSize <- function(method = 'bonferroni'){
  comparisons <- revPLINComparisons(method=method)
  #we can use eta-squared as effect size
  #% of variance in DV(percentcomp) accounted for 
  #by the difference between target1 and target2
...
revPLINComparisonsBayesfollowup <- function() {
  #session1
  blockdefs <- list('S1_first'=c(2,5), 'S1_last'=c(295,6))
  LC_part1 <- getBlockedPLIN(session = 1, blockdefs=blockdefs) 
  #session2
...
#means below
trainPLINComparisonMeans <- function(){
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPLIN(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_7' | LC_part2$set == 'S2_8'),]
...
# trainPLINComparisons <- function(method='bonferroni'){
#   #session2
#   blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
#   LC_part2 <- getBlockedPLIN(session = 2, blockdefs=blockdefs)
#   LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_7' | LC_part2$set == 'S2_8'),]
...
# 
# #effect size
# trainPLINComparisonsEffSize <- function(method = 'bonferroni'){
#   comparisons <- trainPLINComparisons(method=method)
#   #we can use eta-squared as effect size
#   #% of variance in DV(percentcomp) accounted for
#   #by the difference between target1 and target2
#   comparisonsdf <- as.data.frame(comparisons)
...
trainPLINComparisonsBayesfollowup <- function() {
  #session2
  blockdefs <- list('S2_1'=c(2,5), 'S2_2'=c(25,6), 'S2_3'=c(32,5), 'S2_4'=c(55,6), 'S2_5'=c(62,5), 'S2_6'=c(85,6), 'S2_7'=c(92,5), 'S2_8'=c(115,6))
  LC_part2 <- getBlockedPLIN(session = 2, blockdefs=blockdefs) 
  LC4aov <- LC_part2[which(LC_part2$set == 'S2_1' | LC_part2$set == 'S2_2' | LC_part2$set == 'S2_7' | LC_part2$set == 'S2_8'),]
